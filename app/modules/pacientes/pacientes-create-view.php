                ...
                <form id="formGuardarPaciente">
                    <div class="row g-3">
                        <div class="col-xl-4 col-md-6 col-12">
                            <label for="pte_nombres" class="form-label">Nombre(s)</label>
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            ...
                            <select class="form-select" name="pte_pais_nacimiento" id="">
                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            ...
                            <select class="form-select" name="pte_nacionalidad" id="">
                                <option value="">-Seleccionar-</option>
                                <?php
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xl-6 col-md-6 col-12">
                            ...
                            <select class="form-control selectpicker" name="pte_colonia" id="pte_colonia">
