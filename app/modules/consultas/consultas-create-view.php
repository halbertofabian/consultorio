<?php
ComponentesControlador::getBreadCrumb('consultas', 'Consultas', 'Nueva consulta');
$pte_id = $rutas[2];
?>
    ...
    <div class="col-xl-6 col-md-12 col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="formGuardarConsulta" class="row g-3">
                    <div class="col-xl-12 col-md-12 col-12">
                        <label for="cta_subjetivo" class="form-label">Subjetivo</label>
                        <input type="hidden" name="cta_pte_id" id="cta_pte_id" value="<?= base64_decode($pte_id) ?>">
...
<script>
    ...
    $('#formGuardarConsulta').on('submit', function(e) {
        e.preventDefault();
        var datos = new FormData(this)
        $.ajax({
            type: 'POST',
            url: '<?= HTTP_HOST ?>' + 'api/v1/consultas/create',
            data: datos,
            dataType: 'json',
            processData: false,
            contentType: false,
